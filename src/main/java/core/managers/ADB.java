...
public class ADB {
    ...
    public static String command(String command){
        ...
        else throw new RuntimeException("This methode is designed to run ADB commands only!");
        MyLogger.log.debug("Formatted ADB Commands: "+command);
        String output = ServerManager.runCommand(command);
        MyLogger.log.debug("Output of the ADB Commands: "+output);
    ...
    public void forceStopApp(String packageID){
        command("adb -s "+ID+" shel am force-stop "+packageID);
    }
